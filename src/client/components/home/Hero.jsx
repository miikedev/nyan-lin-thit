  ...
  return (
    <Box className="w-full flex hero">
      ...
      <Box className="relative top-[100px]">
        <h1 className='font-bold text-[70px]'>Nyan Lin Thit</h1>
        <Button disableRipple={true} className="hover:bg-primary hover:bg-opacity-none absolute right-[-60px] z-50 px-4 py-8 bg-primary text-white w-48 text-3xl" radius='sm'>Analytica</Button>
        <Box className='relative top-[100px]'>
