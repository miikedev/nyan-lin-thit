	...
	return (
		<>
			<div className={`
				...
				: "w-full h-[150px] max-md:w-[320px] max-md:h-[100px] lg:max-xl:h-[120px] border-[1px] border-[#e6e6e6] bg-white rounded-md grid grid-cols-3 justify-center items-center pl-[25px]"
				}
			`}>
